...
export class ComponentHandler {
  ...
  private async loadCategory(
    ...
    // Folders like modals/ may legitimately have no handlers yet (nothing in
    // the bot currently opens a modal). Missing or empty is a normal,
    // expected state here — not a startup failure. Only genuine read errors
    // (permissions, corrupted path) should be logged as errors.
